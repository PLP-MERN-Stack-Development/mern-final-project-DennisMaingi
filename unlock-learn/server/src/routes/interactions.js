...
router.get('/overview', protect, async (req, res) => {
  try {
    ...
    const totalUsers = await UserInteraction.distinct('user_id').then(users => users.length);
    const totalCourses = await UserInteraction.distinct('course_id').then(courses => courses.length);
